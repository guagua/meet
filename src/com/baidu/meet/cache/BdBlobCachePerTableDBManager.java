...
public class BdBlobCachePerTableDBManager extends BdCacheBaseDBManager<byte[]>{
	...
	public String onNewNameSpaceCreated(String nameSpace){
		...
		String sql1 = "CREATE TABLE IF NOT EXISTS " + m_tableName
	...
	protected BdCacheItem<byte[]> getFromDB(SQLiteDatabase db, String uniqueKey) throws Throwable {
		...
		try{
			c= db.rawQuery("SELECT m_key, saveTime, lastHitTime, timeToExpire, m_value  FROM " + tableName + " where m_key = ?", new String[]{uniqueKey}) ;
