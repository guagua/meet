...
import com.baidu.meet.dbcache.safe.BdCloseHelper;
import com.baidu.meet.dbcache.safe.ThreadService;
...
////		try{
////			if(nameSpace != null){
////				return helper.getSharedWritableDB().delete(tableName, "m_ns = ?", new String[] { nameSpace });
////			}else{
////				return helper.getSharedWritableDB().delete(tableName, null, new String[0]);
////			}
////		}catch(Throwable t){
////			helper.notifyExceptionOnSharedDB(t) ;
...
//		try{
//			if(nameSpace != null){
//				c= helper.getSharedWritableDB().rawQuery("SELECT m_key, m_ns, lastHitTime, timeToExpire, m_value  FROM " + tableName + " where m_ns = ?", new String[]{nameSpace}) ;
//			}else{
//				c= helper.getSharedWritableDB().rawQuery("SELECT m_key, lastHitTime, timeToExpire, m_value  FROM " + tableName , new String[0]) ;
//			}
//			
//			while (c.moveToNext()) {
...
//			helper.notifyExceptionOnSharedDB(t) ;
//			
//			MeetLog.e(tag, nameSpace, t.getMessage()) ;
//		}finally{
...
//	}
	 ...
	 * FIXME: 重新测试下删除性能
	 * 
	 * <p>在ZET的一台普通手机上测试数据如下：
	 * <br>
	 * 在1000条记录的表中逐个删除1000条，耗时171876ms，平均单条172ms；
	 * <br>
	 * 在282条记录的表中逐个删除282条，耗时59232ms，平均单条210ms；
	 * <br>
