...
public class BdNameSpaceDBManager {
	...
	public BdCacheNSItem get(String nameSpace){
		...
		try{
			c= helper.getSharedWritableDB().rawQuery("SELECT nameSpace, tableName, maxSize, cacheType, cacheVersion, lastActiveTime FROM " + BdSQLiteHelper.TABLE_CACHE_META_INFO + " where nameSpace = ?", new String[]{nameSpace}) ;
